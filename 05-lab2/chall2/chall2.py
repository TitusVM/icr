...
class PureEdDSA(object):
    ...
    def sign(self, privkey, pubkey, msg, ctx, hflag):
        ...
        # New mistake here: khashMessage is used instead of khash.
        # So if we send an empty string to be signed khashMessage will be khash (derived directly from the private key)
        ...
        # The mistake has been fixed (here a is s).
